...
BERT_MODEL_PATH = '../input/bert-pretrained-models/cased_L-12_H-768_A-12/'
...
bert_config = BertConfig(
    '../input/bert-pretrained-models/cased_L-12_H-768_A-12/' + 'bert_config.json')
...
output_model_file = "./weithts/bert_pytorch_base_uncased.bin"
