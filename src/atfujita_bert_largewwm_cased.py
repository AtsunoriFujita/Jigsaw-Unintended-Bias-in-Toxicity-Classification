...
BERT_MODEL_PATH = '../input/bert-pretrained-models/wwm_cased_L-24_H-1024_A-16/'
...
bert_config = BertConfig(
    '../input/bert-pretrained-models/wwm_cased_L-24_H-1024_A-16/' + 'bert_config.json')
...
output_model_file = "./weights/bert_pytorch__largewwm_cased.bin"
